                ...
                cart.map(value =>
                  <tr className="hover:bg-gray-50 transition-colors" key={value.id}>
                    ...
                    <td className="px-6 py-4 text-center">
                      <button className="inline-flex items-center justify-center w-7 h-7 bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white rounded-full transition-all active:scale-90 font-bold shadow-sm" onClick={() => { dispatch(addCount(v.id)) }}>
                        +
                      </button>
                    </td>
                  </tr>
